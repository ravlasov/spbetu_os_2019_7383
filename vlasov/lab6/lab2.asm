...
START:     JMP     BEGIN
; ДАННЫЕ
MEM db 13, 10, "Segment address of the inaccessible memory:     h$"
ENV db 13, 10, "Segment address of the environment :     h$"
TAIL db 13, 10, "Tail of the command line: $"
EMP db 13, 10, "There are no sybmols in the tail of the command line$"
CONT db 13, 10, "Contents:", 13, 10, "$"
PATH db 13, 10, "Module path: $", 13, 10, "$"
ENT db 13, 10, "$"
